...
//        return ok(erro);
    ...
    public Result getByTag(String tagString) {
        try {
            ...
            CriteriaWorkflowMatchTag criteria = new CriteriaWorkflowMatchTag(tagId);
            List<Workflow> workflowList = criteria.meetCriteria(Lists.newArrayList(workflows));
    ...
    public Result getByTitle(String title) {
        try {
            ...
            CriteriaWorkflowMatchTitle criteria = new CriteriaWorkflowMatchTitle(title);
            List<Workflow> workflowList = criteria.meetCriteria(Lists.newArrayList(workflows));
