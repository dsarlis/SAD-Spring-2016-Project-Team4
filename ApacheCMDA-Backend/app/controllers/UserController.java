...
public class UserController extends Controller {
	...
	public Result userSearch(String display_name, String format) {
		...
		List<User> objects = userRepository.getAllUsers();
        CriteriaUsernameMatch criteria = new CriteriaUsernameMatch(display_name);
        List<User> users = criteria.meetCriteria(objects);
