...
public class NotificationController extends Controller {
    ...
    {
        String requestStr = Constants.NEW_BACKEND + "users/getFriendRequests/userId/" + session("id");
        JsonNode response = adapter.callAPI(requestStr);
    ...
    private static List<PMessage> getMail(String type)
    {
        ...
        JsonNode response = adapter.callAPI(apiquery);
    ...
    public static Result sendMessage()
    {
        ...
        JsonNode response = adapter.postAPI(apiquery, jnode);
    ...
    public static List<Workflow> getTop3Workflow() {
        ...
        JsonNode response = adapter.callAPI(Constants.NEW_BACKEND + "workflow/getTop3WorkFlow");
        for (JsonNode n : response) {
