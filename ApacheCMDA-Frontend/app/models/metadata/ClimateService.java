...
public class ClimateService {
	...
	public static List<ClimateService> all() {
		...
		JsonNode climateServicesNode = adapter
	...
	public static JsonNode create(JsonNode jsonData) {
		return adapter.postAPI(ADD_CLIMATE_SERVICE_CALL, jsonData);
	}
	...
	public static JsonNode edit(String climateServiceName, JsonNode jsonData) throws UnsupportedEncodingException {
		return adapter.putAPI(EDIT_CLIMATE_SERVICE_CALL + URLEncoder.encode(climateServiceName, "UTF-8"), jsonData);
	}
	...
	public static JsonNode delete(String climateServiceId) throws UnsupportedEncodingException {
		return adapter.deleteAPI(DELETE_CLIMATE_SERVICE_CALL
